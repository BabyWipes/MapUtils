...
public class MapUtils extends JavaPlugin implements Listener {
    ...
    public void blockBreak(BlockBreakEvent event) {
        ...
        if (getConfig().getBoolean("build-protection")) {
            if (!p.hasPermission("battleutils.build." + p.getWorld().getName())) {
                event.setCancelled(true);
                p.sendMessage(ChatColor.RED + "You can't build in this world!");
                p.sendMessage(ChatColor.RED + "Required permission: " + "battleutils.build." + p.getWorld().getName());
            }
        }
    }
